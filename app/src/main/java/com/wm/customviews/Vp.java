 ...
 */
public class Vp extends ViewGroup {
    ...
    private Padapter.DataSetObserver mObserver;
    ...
    public interface OnPageChangeListener {
         ...
         * @see Vp#SCROLL_STATE_IDLE
         * @see Vp#SCROLL_STATE_DRAGGING
         * @see Vp#SCROLL_STATE_SETTLING
         */
    ...
    public void setAdapter(Padapter adapter) {
        if (mAdapter != null) {
    ...
    private class DataSetObserver implements Padapter.DataSetObserver {
        @Override
